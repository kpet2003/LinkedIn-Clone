...
INSERT INTO user (admin, email, first_name, last_name, phone_number, work_title, workplace, role_id, password, is_public_education, is_public_skills, is_public_work_experience, last_chat_user_id)
VALUES 
	(1,'admin@gmail.com',NULL,NULL,1234567,NULL,NULL,1,'admin',1,1,1, 0),
    (0, 'john.doe@gmail.com', 'John', 'Doe', 1234567890, 'Software Engineer', 'Google', 2, '1234', 1, 1, 1, 3),
    (0, 'jane.smith@gmail.com', 'Jane', 'Smith', 9876543210, 'Product Manager', 'Microsoft', 2, '1234', 0, 1, 1, 2),
    (0, 'alice.johnson@gmail.com', 'Alice', 'Johnson', 1928374650, 'Data Scientist', 'Facebook', 2, '1234', 1, 0, 1, 5),
    (0, 'bob.brown@gmail.com', 'Bob', 'Brown', 1029384756, 'UX Designer', 'Amazon', 2, '1234', 1, 1, 0, 4),
        (0, 'charlie.davis@gmail.com', 'Charlie', 'Davis', 1122334455, 'DevOps Engineer', 'Netflix', 2, '1234', 1, 1, 1, 7),
    (0, 'emily.miller@gmail.com', 'Emily', 'Miller', 2233445566, 'Marketing Specialist', 'Spotify', 2, '1234', 0, 1, 0, 6),
    (0, 'david.wilson@gmail.com', 'David', 'Wilson', 3344556677, 'Sales Manager', 'Oracle', 2, '1234', 1, 1, 0, 9),
    (0, 'michael.moore@gmail.com', 'Michael', 'Moore', 4455667788, 'Cybersecurity Expert', 'Cisco', 2, '1234', 1, 0, 1, 8),
    (0, 'olivia.white@gmail.com', 'Olivia', 'White', 5566778899, 'Software Architect', 'IBM', 2, '1234', 1, 1, 1, 11),
    (0, 'lucas.king@gmail.com', 'Lucas', 'King', 6677889900, 'Business Analyst', 'Salesforce', 2, '1234', 1, 0, 1, 10),
    (0, 'mia.harris@gmail.com', 'Mia', 'Harris', 7788990011, 'Frontend Developer', 'Adobe', 2, '1234', 1, 1, 0, 13),
    (0, 'noah.martinez@gmail.com', 'Noah', 'Martinez', 8899001122, 'Backend Developer', 'Red Hat', 2, '1234', 0, 1, 1, 12),
    (0, 'ella.rodriguez@gmail.com', 'Ella', 'Rodriguez', 9900112233, 'Project Manager', 'Uber', 2, '1234', 1, 1, 0, 15),
    (0, 'sophia.walker@gmail.com', 'Sophia', 'Walker', 1011121314, 'IT Consultant', 'Deloitte', 2, '1234', 1, 1, 1, 14),
    (0, 'ethan.lee@gmail.com', 'Ethan', 'Lee', 1112131415, 'Product Designer', 'Slack', 2, '1234', 1, 0, 1, 17),
    (0, 'liam.baker@gmail.com', 'Liam', 'Baker', 1213141516, 'Marketing Director', 'Pinterest', 2, '1234', 1, 1, 0, 16),
    (0, 'ava.clark@gmail.com', 'Ava', 'Clark', 1314151617, 'Content Strategist', 'Medium', 2, '1234', 0, 1, 1, 0),
    (0, 'mason.jones@gmail.com', 'Mason', 'Jones', 1415161718, 'Cloud Engineer', 'AWS', 2, '1234', 1, 1, 1, 0),
    (0, 'isabella.davis@gmail.com', 'Isabella', 'Davis', 1516171819, 'Graphic Designer', 'Canva', 2, '1234', 1, 0, 1, 0),
    (0, 'james.moore@gmail.com', 'James', 'Moore', 1617181920, 'Network Administrator', 'AT&T', 2, '1234', 1, 1, 0, 0),
    (0, 'logan.garcia@gmail.com', 'Logan', 'Garcia', 1718192021, 'System Administrator', 'IBM', 2, '1234', 0, 1, 1, 0),
    (0, 'sebastian.martin@gmail.com', 'Sebastian', 'Martin', 1820212223, 'HR Manager', 'LinkedIn', 2, '1234', 1, 1, 0, 0),
    (0, 'zoe.thomas@gmail.com', 'Zoe', 'Thomas', 1920222324, 'SEO Specialist', 'Shopify', 2, '1234', 0, 1, 1, 0),
    (0, 'joseph.jackson@gmail.com', 'Joseph', 'Jackson', 2023242526, 'Tech Lead', 'GitHub', 2, '1234', 1, 0, 1, 0),
    (0, 'chloe.wilson@gmail.com', 'Chloe', 'Wilson', 2134252627, 'Web Developer', 'GoDaddy', 2, '1234', 1, 1, 0, 0),
    (0, 'daniel.evans@gmail.com', 'Daniel', 'Evans', 2245262728, 'Game Developer', 'Riot Games', 2, '1234', 0, 1, 1, 0),
    (0, 'madison.hall@gmail.com', 'Madison', 'Hall', 2356272829, 'Product Marketer', 'Zendesk', 2, '1234', 1, 1, 0, 0),
    (0, 'joshua.taylor@gmail.com', 'Joshua', 'Taylor', 2467282930, 'Data Engineer', 'Palantir', 2, '1234', 1, 0, 1, 0),
    (0, 'matthew.allen@gmail.com', 'Matthew', 'Allen', 2578293031, 'AI Specialist', 'OpenAI', 2, '1234', 1, 1, 1, 0),
    (0, 'alex.miller@gmail.com', 'Alex', 'Miller', 2689303132, 'Site Reliability Engineer', 'Google', 2, '1234', 0, 1, 0, 0),
    (0, 'luke.young@gmail.com', 'Luke', 'Young', 2790313233, 'Mobile Developer', 'Snapchat', 2, '1234', 1, 1, 1, 0),
    (0, 'natalie.carter@gmail.com', 'Natalie', 'Carter', 2801323334, 'Full Stack Developer', 'Stripe', 2, '1234', 1, 0, 1, 0),
    (0, 'grace.hill@gmail.com', 'Grace', 'Hill', 2912333435, 'Growth Hacker', 'Airbnb', 2, '1234', 0, 1, 1, 0),
    (0, 'andrew.scott@gmail.com', 'Andrew', 'Scott', 3023343536, 'IT Support', 'HP', 2, '1234', 1, 1, 0, 0),
    (0, 'sarah.green@gmail.com', 'Sarah', 'Green', 3134353637, 'DevOps Consultant', 'Accenture', 2, '1234', 1, 0, 1, 0),
    (0, 'oliver.adams@gmail.com', 'Oliver', 'Adams', 3245363738, 'Cloud Architect', 'Google Cloud', 2, '1234', 1, 1, 0, 0),
    (0, 'benjamin.campbell@gmail.com', 'Benjamin', 'Campbell', 3356373839, 'Machine Learning Engineer', 'DeepMind', 2, '1234', 0, 1, 1, 0),
    (0, 'lucas.perry@gmail.com', 'Lucas', 'Perry', 3467383940, 'Blockchain Developer', 'Coinbase', 2, '1234', 1, 1, 0, 0),
    (0, 'victoria.morgan@gmail.com', 'Victoria', 'Morgan', 3578394041, 'IT Consultant', 'SAP', 2, '1234', 1, 0, 1, 0),
    (0, 'jackson.hughes@gmail.com', 'Jackson', 'Hughes', 3689404142, 'Business Intelligence Analyst', 'Zoom', 2, '1234', 0, 1, 1, 0),
    (0, 'nathan.henderson@gmail.com', 'Nathan', 'Henderson', 3790414243, 'Security Engineer', 'CrowdStrike', 2, '1234', 1, 1, 0, 0),
    (0, 'lily.ward@gmail.com', 'Lily', 'Ward', 3901424344, 'Web Developer', 'Wix', 2, '1234', 1, 0, 1, 0),
    (0, 'alexander.cooper@gmail.com', 'Alexander', 'Cooper', 4012434445, 'AI Researcher', 'Meta AI', 2, '1234', 1, 1, 0, 0),
    (0, 'hailey.foster@gmail.com', 'Hailey', 'Foster', 4123444546, 'UI Designer', 'Adobe', 2, '1234', 0, 1, 1, 0);
...
CREATE TABLE `job_views` (
  ...
  `job_id` bigint NOT NULL,
  KEY `FKjf86l6wavjak0w0rmgx51c07d` (`job_id`),
  KEY `FKlt2ebqil6ynwa3orbm3jdhpnf` (`user`),
  CONSTRAINT `FKjf86l6wavjak0w0rmgx51c07d` FOREIGN KEY (`job_id`) REFERENCES `job` (`id`),
  CONSTRAINT `FKlt2ebqil6ynwa3orbm3jdhpnf` FOREIGN KEY (`user`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO job_views (user, job_id) VALUES
-- Job 1
(2, 1), (3, 1), (4, 1), (5, 1), (6, 1),
-- Job 2
...
-- Job 16
(33, 16), (34, 16), (35, 16), (36, 16), (37, 16),
-- Job 17
(38, 17), (39, 17), (40, 17), (41, 17), (42, 17),
-- Job 18
(43, 18), (44, 18), (45, 18), (2, 18), (3, 18),
-- Job 19
...
-- Job 26
(39, 26), (40, 26), (41, 26), (42, 26), (43, 26),
-- Job 27
(44, 27), (45, 27), (2, 27), (3, 27), (4, 27),
-- Job 28
...
-- Job 33
(30, 33), (31, 33), (32, 33), (33, 33), (34, 33),
-- Job 34
(35, 34), (36, 34), (37, 34), (38, 34), (39, 34),
-- Job 35
(40, 35), (41, 35), (42, 35), (43, 35), (44, 35),
-- Job 36
(45, 36), (2, 36), (3, 36), (4, 36), (5, 36),
-- Job 37
...
-- Job 45
(2, 45), (3, 45), (4, 45), (5, 45), (6, 45),
-- Job 46
(7, 46), (8, 46), (9, 46), (10, 46), (11, 46),
-- Job 47
(12, 47), (13, 47), (14, 47), (15, 47), (16, 47),
-- Job 48
(17, 48), (18, 48), (19, 48), (20, 48), (21, 48),
-- Job 49
(22, 49), (23, 49), (24, 49), (25, 49), (26, 49),
-- Job 50
(27, 50), (28, 50), (29, 50), (30, 50), (31, 50),
-- Job 51
(32, 51), (33, 51), (34, 51), (35, 51), (36, 51),
-- Job 52
(37, 52), (38, 52), (39, 52), (40, 52), (41, 52),
-- Job 53
(42, 53), (43, 53), (44, 53), (45, 53), (2, 53);
